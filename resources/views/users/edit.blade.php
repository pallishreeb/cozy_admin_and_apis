...
@section('content')
    <div class="container mx-auto py-6">
        <h2 class="text-2xl text-center font-semibold text-gray-800 mb-6">Edit User</h2>
        <form method="POST" action="{{ route('manage_users.update', $user->id) }}" class="max-w-md mx-auto bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
            ...
            <div class="mb-6">
                <label class="block text-gray-700 text-sm font-bold mb-2" for="mobile_number">Mobile:</label>
                <input type="text" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="mobile_number" name="mobile_number" value="{{ $user->mobile_number }}">
            </div>
